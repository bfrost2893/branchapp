...
var   window_height = $(window).height(),
	  ...
	  // zipError = '<div class="alert-message error">Please enter your zip code.<span class="close" href="#">x</span></div>',
	...
	/* ------------------------------------------------------------------------ */
	  ...
	  function Callback(response) {
		if (response.responseStatus == 'err') {
		 ...
		 //  else if (response.responseMsg == 'zipcode') {
		 ...
		 //  } 
		  ...
		  alert('Thanks for trying out Branch beta! We will e-mail you the link to download for iPhone or Android.');
		} else {
		  alert('Undocumented error. Please refresh the page and try again.');
		}
	  }
